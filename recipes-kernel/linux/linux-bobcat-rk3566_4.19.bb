DESCRIPTION = "Linux kernel for Bobcat RK3566"
...
do_deploy_append() {
	...
	install -m 644 ${WORKDIR}/linux-bobcat_rk3566-standard-build/arch/arm64/boot/dts/rockchip/overlay/* ${DEPLOYDIR}/overlays
}
